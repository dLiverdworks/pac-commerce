...
class Membership:
    ...
    def predict_membership(self, username: str, 
        ...
        """
        Method yang digunakan untuk memprediksi user masuk ke tier membership apa dengan menggunakan
        Euclidean Distance

        Parameters
        ----------
        username (str): username dari user
        monthly_expense (float): pengeluaran perbulan dari user dalam format juta
        monthly_income (float): pemasukan perbulan dari user dalam format juta
        """
        ...
        # store the ecludean distance values to dictionary
        dict_result = {
...
# init object
user_1 = Membership(username = "Mishbah")

# check username
print(user_1.username)

# predict membership
user_1.predict_membership(username = "Mishbah",
                          monthly_expense = 3,
                          monthly_income = 25)
